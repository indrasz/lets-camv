...
<main class="h-full overflow-y-auto">
    ...
    <nav class="mx-10 mt-8 text-sm" aria-label="Breadcrumb">
        <ol class="inline-flex p-0 list-none">
            ...
            <li class="flex items-center">
                <a href="#" class="font-medium">Edit Destination</a>
            </li>
        </ol>
    </nav>
                            ...
                            <div class="px-4 py-5 sm:p-6">
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6">
                                        <label for="name" class="block mb-3 font-medium text-gray-700 text-md">Nama Destinasi</label>

                                        <input placeholder="Nama Destinasi yang ingin ditambahkan" type="text" name="name" id="name" autocomplete="name" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"  value="{{ $destination->name ?? '' }}" required>
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input placeholder="Deskripsi dari destinasi" type="text" name="description" id="description" autocomplete="description" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ $destination->description ?? '' }}" required>
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        <select id="categories_id" name="categories_id" autocomplete="categories_id" class="block w-full px-3 py-3 pr-10 mt-1 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                                            <option value="{{ $destination->categories_id  ?? '' }}"> {{$destination->category->name}} </option>
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input placeholder="Total Harga Destinasi" type="number" name="price" id="price" autocomplete="price" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ $destination->price ?? '' }}" required>
                                    ...
                                    <div class="col-span-6">
                                        <label for="photos" class="block mb-3 font-medium text-gray-700 text-md">Thumbnail Service Feeds</label>
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input placeholder="Hal yang ingin disampaikan oleh kamu?" type="text" name="location" id="location" autocomplete="location" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ $destination->location ?? '' }}">
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input placeholder="Tambah Minimum Order" type="number" name="orderDay" id="orderDay" autocomplete="orderDay" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ $destination->orderDay ?? '' }}"">
...
@push('after-script')
    ...
    <script type="text/javascript">
        ...
        $("#addThumbnailRow").click(function() {
            var html = '';
            html += '<input placeholder="Thumbnail" type="file" name="photo[]" id="photo" autocomplete="photo" class="block w-full py-3 pl-5 mt-1 border border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>';
