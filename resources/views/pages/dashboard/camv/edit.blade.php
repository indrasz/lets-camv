    ...
    <nav class="mx-10 mt-8 text-sm" aria-label="Breadcrumb">
        <ol class="inline-flex p-0 list-none">
            <li class="flex items-center">
                <a href="{{ route('dashboard.camv.index') }}" class="text-gray-400">My Services</a>
        ...
        <div class="grid gap-5 md:grid-cols-12">
            <main class="col-span-12 p-4 md:pt-0">
                <div class="px-2 py-2 mt-2 bg-white rounded-xl">
                    ...
                    <form action="{{ route('dashboard.camv.update', [$camv->id]) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                            ...
                            <div class="px-4 py-5 sm:p-6">
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6">
                                        ...
                                        <input placeholder="Service apa yang ingin kamu tawarkan?" type="text" name="title" id="title" autocomplete="title" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ $camv->name ?? '' }}" required>
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        <select id="revision_limit" name="revision_limit" autocomplete="revision_limit" class="block w-full px-3 py-3 pr-10 mt-1 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                                            ...
                                            <option value="5" {{ $service->revision_limit == '5' ? 'selected' : '' }}>4 Revisi</option>
                                            <option value="7" {{ $service->revision_limit == '7' ? 'selected' : '' }}>8 Revisi</option>
                                            <option value="10" {{ $service->revision_limit == '10' ? 'selected' : '' }}>16 Revisi</option>
                                            <option value="12" {{ $service->revision_limit == '12' ? 'selected' : '' }}>32 Revisi</option>
                                        </select>
                                    </div>
                            ...
                            <div class="px-4 py-5 sm:p-6">
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input placeholder="Nama Destinasi yang ingin ditambahkan" type="text" name="name" id="name" autocomplete="name" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ $camv->name ?? '' }}" required>
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input placeholder="Total Harga Destinasi" type="number" name="price" id="price" autocomplete="price" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ $camv->price ?? '' }}" required>
                                    ...
                                    <div class="col-span-6">
                                        <label for="photo" class="block mb-3 font-medium text-gray-700 text-md">Thumbnail Service Feeds</label>

                                        <div class="mb-2">
                                            <img src="{{ url(Storage::url($camv->photo)) }}" alt="photo" class="inline object-cover w-20 h-20 rounded" for="choose">

                                            <input placeholder="Thumbnail" type="file" name="{{ 'photo['.$camv->id.']' }}" id="photo" autocomplete="photo" class="block w-full py-3 pl-5 mt-3 border-gray-300 rounded-md shadow-sm focus:ring-green-500 sm:text-sm">
                                        </div>
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input placeholder="Tambah Minimum Order" type="number" name="orderDay" id="orderDay" autocomplete="orderDay" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ $camv->orderDay ?? '' }}"">
                                    ...
                                    <div class="col-span-6">
                                        <label for="feature" class="block mb-3 font-medium text-gray-700 text-md">Keunggulan kamu</label>

                                        @forelse ($feature as $features_item)
                                            <input placeholder="feature" type="text" name="{{ ('features['.$features_item->id.']') }}" id="features" autocomplete="features" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ $features_item->feature ?? '' }}" required>
                                        @empty
                                            {{-- empty --}}
                                        @endforelse
